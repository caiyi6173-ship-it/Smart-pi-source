...
# 三元素（iot后台获取）
ProductKey = 'k21bbO0lcFq'
DeviceName = 'rp_1'
DeviceSecret = "bc33f146250b5f1441472c6975d19984"
# topic (iot后台获取)
POST = '/sys/k21bbO0lcFq/rp_1/thing/event/property/post'  # 上报消息到云
POST_REPLY = '/sys/k21bbO0lcFq/rp_1/thing/event/property/post_reply'  
SET = '/sys/k21bbO0lcFq/rp_1/thing/service/property/set'  # 订阅云端指令
